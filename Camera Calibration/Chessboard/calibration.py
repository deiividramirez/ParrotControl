...
# [[537.77241654   0.         428.02713813]
#  [  0.         528.01315734 242.58332781]
#  [  0.           0.           1.        ]]
# dist (before) : 
# [[ 0.00954521  0.00342382  0.00059917  0.0000472  -0.06279676]]

# Height: 480, Width: 856
# Cx: 428.0, Cy: 240.0

# Camera matrix (after) : 
# [[532.14788818   0.         427.58317355]
#  [  0.         527.76635742 242.28555368]
#  [  0.           0.           1.        ]]
# dist (after) : 
# (0, 0, 855, 479)
# Total error:  0.43451426652034947


####################################################################################################
# Camera matrix (before) : 
# [[537.05777255   0.         428.22795447]
#  [  0.         527.30057446 242.8484164 ]
#  [  0.           0.           1.        ]]
# dist (before) : 
# [[ 0.00785746  0.00441467  0.00076425 -0.00010309 -0.05922106]]

# Height: 480, Width: 856
# Cx: 428.0, Cy: 240.0

# Camera matrix (after) : 
# [[531.54418945   0.         427.63074519]
#  [  0.         526.90557861 242.60721637]
#  [  0.           0.           1.        ]]
# dist (after) : 
# (0, 0, 855, 479)
# Total error:  0.43765056744243114

####################################################################################################
# Camera matrix (before) : 
# [[536.34451724   0.         428.01238391]
#  [  0.         526.60653383 243.17280375]
#  [  0.           0.           1.        ]]
# dist (before) : 
# [[ 0.00787194  0.00622092  0.00093583 -0.00008403 -0.07160359]]

# Height: 480, Width: 856
# Cx: 428.0, Cy: 240.0

# Camera matrix (after) : 
# [[529.22259521   0.         427.41582509]
#  [  0.         526.18310547 242.98438459]
#  [  0.           0.           1.        ]]
# dist (after) : 
# (0, 0, 855, 479)
# Total error:  0.41908175343964454

####################################################################################################
# Camera matrix (before) : 
# [[537.66614662   0.         428.55014303]
#  [  0.         527.74627505 242.61101264]
#  [  0.           0.           1.        ]]
# dist (before) : 
# [[ 0.0097862  -0.00059658  0.0005772   0.00018775 -0.07078375]]

# Height: 480, Width: 856
# Cx: 428.0, Cy: 240.0

# Camera matrix (after) : 
# [[529.82824707   0.         428.33578487]
#  [  0.         527.38256836 242.30389693]
#  [  0.           0.           1.        ]]
# dist (after) : 
# (0, 0, 855, 479)
# Total error:  0.4007858635030898
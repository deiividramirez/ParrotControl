...
fig2, ax2 = plt.subplots(3, 2, figsize=(10, 7), num=f"Angles", sharex=True)
time = np.load(f"{PATH}/out/drone_{DRONE}_anglesTime.npy")
angles1 = np.load(f"{PATH}/out/drone_{DRONE}_angles1.npy").T
angles2 = np.load(f"{PATH}/out/drone_{DRONE}_angles2.npy").T
...
ax2[0, 0].plot(time[:maxangle, 0], angles1[:maxtime, 0], "-", label="pitch - R1")
ax2[0, 0].plot(time[:maxangle, 0], angles1[:maxtime, 1], "-", label="yaw - R1")
ax2[0, 0].plot(time[:maxangle, 0], angles1[:maxtime, 2], "-", label="roll - R1")
ax2[1, 0].title.set_text("Angles 2")
ax2[1, 0].plot(time[:maxangle, 0], angles1[:maxtime, 3], "-", label="pitch - R2")
ax2[1, 0].plot(time[:maxangle, 0], angles1[:maxtime, 4], "-", label="yaw - R2")
ax2[1, 0].plot(time[:maxangle, 0], angles1[:maxtime, 5], "-", label="roll - R2")
ax2[2, 0].title.set_text("Angles 3")
ax2[2, 0].plot(time[:maxangle, 0], angles1[:maxtime, 6], "-", label="pitch - R3")
ax2[2, 0].plot(time[:maxangle, 0], angles1[:maxtime, 7], "-", label="yaw - R3")
ax2[2, 0].plot(time[:maxangle, 0], angles1[:maxtime, 8], "-", label="roll - R3")
ax2[0, 0].legend(loc="best", bbox_to_anchor=(1, 0.5))
ax2[1, 0].legend(loc="best", bbox_to_anchor=(1, 0.5))
ax2[2, 0].legend(loc="best", bbox_to_anchor=(1, 0.5))

ax2[0, 1].title.set_text("Angles 1")
ax2[0, 1].plot(time[:maxangle, 0], angles2[:maxtime, 0], "-", label="pitch - R1")
ax2[0, 1].plot(time[:maxangle, 0], angles2[:maxtime, 1], "-", label="yaw - R1")
ax2[0, 1].plot(time[:maxangle, 0], angles2[:maxtime, 2], "-", label="roll - R1")
ax2[1, 1].title.set_text("Angles 2")
ax2[1, 1].plot(time[:maxangle, 0], angles2[:maxtime, 3], "-", label="pitch - R2")
ax2[1, 1].plot(time[:maxangle, 0], angles2[:maxtime, 4], "-", label="yaw - R2")
ax2[1, 1].plot(time[:maxangle, 0], angles2[:maxtime, 5], "-", label="roll - R2")
ax2[2, 1].title.set_text("Angles 3")
ax2[2, 1].plot(time[:maxangle, 0], angles2[:maxtime, 6], "-", label="pitch - R3")
ax2[2, 1].plot(time[:maxangle, 0], angles2[:maxtime, 7], "-", label="yaw - R3")
ax2[2, 1].plot(time[:maxangle, 0], angles2[:maxtime, 8], "-", label="roll - R3")
ax2[0, 1].legend(loc="best", bbox_to_anchor=(1, 0.5))
ax2[1, 1].legend(loc="best", bbox_to_anchor=(1, 0.5))
ax2[2, 1].legend(loc="best", bbox_to_anchor=(1, 0.5))
